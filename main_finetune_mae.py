...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='./checkpoints/checkpoint_final.pth.tar', help='finetune from checkpoint')
    ...
    parser.add_argument('--dataset', default='AVA', type=str)
...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for data_iter_step, (samples, targets) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        # tensor([8, 10, 13, 12, 12, 17, 1, 17, 0, 11, 0, 7, 5, 2, 13, 18, 4, 4,
        #         17, 6, 9, 16, 4, 5, 9, 12, 2, 11, 0, 6, 15, 3],
        #        device='cuda:0')
