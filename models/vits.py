...
class VisionTransformerMoCo(VisionTransformer):
    def __init__(self, stop_grad_conv1=False,add1BlockTo=-1,add1BlockToNumLayers=1, **kwargs):
        super().__init__(**kwargs)
        # Use fixed 2D sin-cos position embedding
        self.build_2d_sincos_position_embedding()
        self.recorded_feature = None
        self.add1BlockTo = add1BlockTo
        self.add1BlockToNumLayers = add1BlockToNumLayers
        self.dis_token = None
    ...
    def build_2d_sincos_position_embedding(self, temperature=10000.):
        # 改动
        self.patch_embed.grid_size = (self.patch_embed.img_size[0] // self.patch_embed.patch_size[0], self.patch_embed.img_size[1] // self.patch_embed.patch_size[1])
        ...
        # assert self.num_tokens == 1, 'Assuming one and only one token, [cls]'  #改动
